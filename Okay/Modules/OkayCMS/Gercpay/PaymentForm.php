...
/**
 * Class PaymentForm
 * @package Okay\Modules\OkayCMS\Gercpay
 */
class PaymentForm extends AbstractModule implements PaymentFormInterface
{
    ...
    public function checkoutForm($orderId)
    {
        ...
        $this->design->assign('merchant_id', $settings['gercpay_merchant']);
        ...
        $this->design->assign('callback_url', Router::generateUrl('OkayCMS_Gercpay_callback', [], true));
    ...
    private function generateHash($settings)
    {
        ...
        return hash_hmac('md5', $hash, $settings['gercpay_secretkey']);
    }
